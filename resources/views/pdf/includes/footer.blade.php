<div id="footer mt-2" class="footer">
    ...
    <ul class="list-none" style="margin-left: 2rem">
        <li class="li-top text-left">
            <span>
                ...
                <span class="infoA">0032 491 64 64 14</span>
            </span>
            <span>
            ...
            <span>
                ...
                <span class="infoA  ">medicasure.com</span>
            </span>
        </li>
        <li class="text-left">
            <span>
                <span class="title">Adresse :</span>
                <span class="infoA  ">Rue du castel(Irc) 18-7801 Ath Belgique</span>
            </span>
        </li>
    </ul>
</div>