...
```javascript
const url = new URL("localhost/api/groupe-activite");
...
```javascript
const url = new URL("localhost/api/groupe-activite/1");
...
```javascript
const url = new URL("localhost/api/activite");
...
```javascript
const url = new URL("localhost/api/activite/1");
...
```javascript
const url = new URL("localhost/api/activite-cloture/1");
...
```javascript
const url = new URL("localhost/api/activite-mission/1");
...
```javascript
const url = new URL("localhost/api/activite-mission-add");
...
```javascript
const url = new URL("localhost/api/activite-ama/save");
...
```javascript
const url = new URL("localhost/api/activite-ama/create");
...
```javascript
const url = new URL("localhost/api/chat");
...
```javascript
const url = new URL("localhost/api/message");
...
```javascript
const url = new URL("localhost/api/validation/examens/etat");
...
```javascript
const url = new URL("localhost/api/validation/examens/souscripteur");
...
```javascript
const url = new URL("localhost/api/activite-mission-delete/1");
...
```javascript
const url = new URL("localhost/api/show-groupe-activite/1");
...
```javascript
const url = new URL("localhost/api/activite-ama/patient/1");
...
```javascript
const url = new URL("localhost/api/partenaire");
...
```javascript
const url = new URL("localhost/api/partenaire/1");
...
```javascript
const url = new URL("localhost/api/resultat-labo/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-fichier/1/archiver");
...
```javascript
const url = new URL("localhost/api/hospitalisation/1/archiver");
...
```javascript
const url = new URL("localhost/api/resultat-imagerie/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-medecine/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-obstetrique/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-prenatale/1/archiver");
...
```javascript
const url = new URL("localhost/api/ordonance/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-kinesitherapie/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-cardiologie/1/archiver");
...
```javascript
const url = new URL("localhost/api/consultation-cardiologie/1/reactiver");
...
```javascript
const url = new URL("localhost/api/consultation-kinesitherapie/1/reactiver");
...
```javascript
const url = new URL("localhost/api/consultation-medecine/1/reactiver");
...
```javascript
const url = new URL("localhost/api/consultation-obstetrique/1/reactiver");
...
```javascript
const url = new URL("localhost/api/consultation-fichier/1/reactiver");
...
```javascript
const url = new URL("localhost/api/consultation-obstetrique");
...
```javascript
const url = new URL("localhost/api/consultation-obstetrique/1");
...
```javascript
const url = new URL("localhost/api/1/dossier-medical");
...
```javascript
const url = new URL("localhost/api/secretReset/1");
...
```javascript
const url = new URL("localhost/api/consultation-medecine");
...
```javascript
const url = new URL("localhost/api/consultation-cardiologie");
...
```javascript
const url = new URL("localhost/api/consultation-kinesitherapie");
...
```javascript
const url = new URL("localhost/api/motif");
...
```javascript
const url = new URL("localhost/api/motif/1");
...
```javascript
const url = new URL("localhost/api/allergie");
...
```javascript
const url = new URL("localhost/api/allergie/1");
...
```javascript
const url = new URL("localhost/api/antecedent");
...
```javascript
const url = new URL("localhost/api/antecedent/1");
...
```javascript
const url = new URL("localhost/api/traitement-actuel");
...
```javascript
const url = new URL("localhost/api/traitement-actuel/1");
...
```javascript
const url = new URL("localhost/api/traitement-propose");
...
```javascript
const url = new URL("localhost/api/traitement-propose/1");
...
```javascript
const url = new URL("localhost/api/parametre-commun");
...
```javascript
const url = new URL("localhost/api/parametre-commun/1");
...
```javascript
const url = new URL("localhost/api/conclusion");
...
```javascript
const url = new URL("localhost/api/conclusion/1");
...
```javascript
const url = new URL("localhost/api/resultat-labo");
...
```javascript
const url = new URL("localhost/api/resultat-labo/1");
...
```javascript
const url = new URL("localhost/api/resultat-imagerie");
...
```javascript
const url = new URL("localhost/api/resultat-imagerie/1");
...
```javascript
const url = new URL("localhost/api/consultation-prenatale");
...
```javascript
const url = new URL("localhost/api/consultation-prenatale/1");
...
```javascript
const url = new URL("localhost/api/parametre-obstetrique");
...
```javascript
const url = new URL("localhost/api/parametre-obstetrique/1");
...
```javascript
const url = new URL("localhost/api/echographie");
...
```javascript
const url = new URL("localhost/api/echographie/1");
...
```javascript
const url = new URL("localhost/api/hospitalisation");
...
```javascript
const url = new URL("localhost/api/hospitalisation/1");
...
```javascript
const url = new URL("localhost/api/consultation-fichier");
...
```javascript
const url = new URL("localhost/api/consultation-medecine-motif/retirer-motif");
...
```javascript
const url = new URL("localhost/api/consultation-medecine-motif/ajouter-motif");
...
```javascript
const url = new URL("localhost/api/hospitalisation/ajouter-motif");
...
```javascript
const url = new URL("localhost/api/hospitalisation/retirer-motif");
...
```javascript
const url = new URL("localhost/api/retirer-allergie");
...
```javascript
const url = new URL("localhost/api/ajouter-allergie");
...
```javascript
const url = new URL("localhost/api/ajouter-allergie-version");
...
```javascript
const url = new URL("localhost/api/retirer-traitement");
...
```javascript
const url = new URL("localhost/api/ajouter-traitement");
...
```javascript
const url = new URL("localhost/api/max-consultation-obs");
...
```javascript
const url = new URL("localhost/api/latest-operation");
...
```javascript
const url = new URL("localhost/api/categorie");
...
```javascript
const url = new URL("localhost/api/categorie/create");
...
```javascript
const url = new URL("localhost/api/categorie/1");
...
```javascript
const url = new URL("localhost/api/categorie/1/edit");
...
```javascript
const url = new URL("localhost/api/suivi");
...
```javascript
const url = new URL("localhost/api/suivi/create");
...
```javascript
const url = new URL("localhost/api/suivi/1");
...
```javascript
const url = new URL("localhost/api/suivi/1/edit");
...
```javascript
const url = new URL("localhost/api/suivi/search/1");
...
```javascript
const url = new URL("localhost/api/toDoList");
...
```javascript
const url = new URL("localhost/api/toDoList/create");
...
```javascript
const url = new URL("localhost/api/toDoList/1");
...
```javascript
const url = new URL("localhost/api/toDoList/1/edit");
...
```javascript
const url = new URL("localhost/api/toDoList/1/statut");
...
```javascript
const url = new URL("localhost/api/suivi-specialite");
...
```javascript
const url = new URL("localhost/api/suivi-specialite/create");
...
```javascript
const url = new URL("localhost/api/suivi-specialite/1");
...
```javascript
const url = new URL("localhost/api/suivi-specialite/1/edit");
...
```javascript
const url = new URL("localhost/api/suivi-specialites/delete");
...
```javascript
const url = new URL("localhost/api/avis");
...
```javascript
const url = new URL("localhost/api/avis/create");
...
```javascript
const url = new URL("localhost/api/avis/1");
...
```javascript
const url = new URL("localhost/api/avis/1/edit");
...
```javascript
const url = new URL("localhost/api/avisMedecin/1");
...
```javascript
const url = new URL("localhost/api/avis/patient/1");
...
```javascript
const url = new URL("localhost/api/avis-repondre/1");
...
```javascript
const url = new URL("localhost/api/avisMedecin/1/nouveauAvis");
...
```javascript
const url = new URL("localhost/api/compte-rendu-operatoire");
...
```javascript
const url = new URL("localhost/api/compte-rendu-operatoire/1");
...
```javascript
const url = new URL("localhost/api/compte-rendu-operatoire/1/transmettre");
...
```javascript
const url = new URL("localhost/api/compte-rendu-operatoire/1/archiver");
...
```javascript
const url = new URL("localhost/api/compte-rendu-operatoire/1/reactivier");
...
```javascript
const url = new URL("localhost/api/contrat-prepaye-store-patient");
...
```javascript
const url = new URL("localhost/api/contrat-prepaye-store-patient-unpaid");
...
```javascript
const url = new URL("localhost/api/commande-restante/1");
...
```javascript
const url = new URL("localhost/api/get-commande-from-cim");
...
```javascript
const url = new URL("localhost/api/commande-restante/add/1");
...
```javascript
const url = new URL("localhost/api/rdvs");
...
```javascript
const url = new URL("localhost/api/rdvs/create");
...
```javascript
const url = new URL("localhost/api/rdvs/1");
...
```javascript
const url = new URL("localhost/api/rdvs/1/edit");
...
```javascript
const url = new URL("localhost/api/consultation-medecine/create");
...
```javascript
const url = new URL("localhost/api/consultation-medecine/1/edit");
...
```javascript
const url = new URL("localhost/api/consultation-cardiologie/create");
...
```javascript
const url = new URL("localhost/api/consultation-cardiologie/1/edit");
...
```javascript
const url = new URL("localhost/api/consultation-obstetrique/create");
...
```javascript
const url = new URL("localhost/api/consultation-obstetrique/1/edit");
...
```javascript
const url = new URL("localhost/api/motif/create");
...
```javascript
const url = new URL("localhost/api/motif/1/edit");
...
```javascript
const url = new URL("localhost/api/allergie/create");
...
```javascript
const url = new URL("localhost/api/allergie/1/edit");
...
```javascript
const url = new URL("localhost/api/antecedent/create");
...
```javascript
const url = new URL("localhost/api/antecedent/1/edit");
...
```javascript
const url = new URL("localhost/api/traitement-actuel/create");
...
```javascript
const url = new URL("localhost/api/traitement-actuel/1/edit");
...
```javascript
const url = new URL("localhost/api/traitement-propose/create");
...
```javascript
const url = new URL("localhost/api/traitement-propose/1/edit");
...
```javascript
const url = new URL("localhost/api/parametre-commun/create");
...
```javascript
const url = new URL("localhost/api/parametre-commun/1/edit");
...
```javascript
const url = new URL("localhost/api/conclusion/create");
...
```javascript
const url = new URL("localhost/api/conclusion/1/edit");
...
```javascript
const url = new URL("localhost/api/resultat-labo/create");
...
```javascript
const url = new URL("localhost/api/resultat-labo/1/edit");
...
```javascript
const url = new URL("localhost/api/resultat-imagerie/create");
...
```javascript
const url = new URL("localhost/api/resultat-imagerie/1/edit");
...
```javascript
const url = new URL("localhost/api/consultation-prenatale/create");
...
```javascript
const url = new URL("localhost/api/consultation-prenatale/1/edit");
...
```javascript
const url = new URL("localhost/api/parametre-obstetrique/create");
...
```javascript
const url = new URL("localhost/api/parametre-obstetrique/1/edit");
...
```javascript
const url = new URL("localhost/api/echographie/create");
...
```javascript
const url = new URL("localhost/api/echographie/1/edit");
...
```javascript
const url = new URL("localhost/api/hospitalisation/create");
...
```javascript
const url = new URL("localhost/api/hospitalisation/1/edit");
...
```javascript
const url = new URL("localhost/api/consultation-fichier/create");
...
```javascript
const url = new URL("localhost/api/consultation-fichier/1/edit");
...
```javascript
const url = new URL("localhost/api/user-details");
...
```javascript
const url = new URL("localhost/api/validation/examens");
...
```javascript
const url = new URL("localhost/api/validation/examens/count");
...
```javascript
const url = new URL("localhost/api/validation/examens/consultation/1");
...
```javascript
const url = new URL("localhost/api/dossier/create");
...
```javascript
const url = new URL("localhost/api/dossier/1/edit");
...
```javascript
const url = new URL("localhost/api/medecin-patient");
...
```javascript
const url = new URL("localhost/api/medecin-patient/create");
...
```javascript
const url = new URL("localhost/api/medecin-patient/1");
...
```javascript
const url = new URL("localhost/api/medecin-patient/1/edit");
...
```javascript
const url = new URL("localhost/api/dossiers-mes-patient");
...
```javascript
const url = new URL("localhost/api/dossiers-mes-patient/search/1");
...
```javascript
const url = new URL("localhost/api/imprimer-dossier/1");
...
```javascript
const url = new URL("localhost/api/imprimer-facture-definitive/1");
...
```javascript
const url = new URL("localhost/api/imprimer-facture-avis-definitive/1");
...
```javascript
const url = new URL("localhost/api/imprimer-compte-rendu/1");
...
```javascript
const url = new URL("localhost/api/imprimer-facture-proforma/1");
...
```javascript
const url = new URL("localhost/api/imprimer-consultation-medecine/1");
...
```javascript
const url = new URL("localhost/api/imprimer-consultation-cardiologie/1");
...
```javascript
const url = new URL("localhost/api/imprimer-rapport-hospitalisation/1");
...
```javascript
const url = new URL("localhost/api/imprimer-rapport-kinesitherapie/1");
...
```javascript
const url = new URL("localhost/api/affiliationRevue/1");
...
```javascript
const url = new URL("localhost/api/patient/1");
...
```javascript
const url = new URL("localhost/api/patient");
...
```javascript
const url = new URL("localhost/api/patient/search/1");
...
```javascript
const url = new URL("localhost/api/patient/doctor/1");
...
```javascript
const url = new URL("localhost/api/count_patient/doctor/1");
...
```javascript
const url = new URL("localhost/api/patient/doctor/1/1");
...
```javascript
const url = new URL("localhost/api/patient/doctor/1/1/1");
...
```javascript
const url = new URL("localhost/api/souscripteur/1");
...
```javascript
const url = new URL("localhost/api/souscripteur/rappel/1");
...
```javascript
const url = new URL("localhost/api/souscripteur/list/cim");
...
```javascript
const url = new URL("localhost/api/user-etablissements");
...
```javascript
const url = new URL("localhost/api/update-password");
...
```javascript
const url = new URL("localhost/api/facture/1");
...
```javascript
const url = new URL("localhost/api/import_csv");
...
```javascript
const url = new URL("localhost/api/categorie-prestation");
...
```javascript
const url = new URL("localhost/api/categorie-prestation/create");
...
```javascript
const url = new URL("localhost/api/categorie-prestation/1");
...
```javascript
const url = new URL("localhost/api/categorie-prestation/1/edit");
...
```javascript
const url = new URL("localhost/api/etablissement-prestation");
...
```javascript
const url = new URL("localhost/api/etablissement-prestation/create");
...
```javascript
const url = new URL("localhost/api/etablissement-prestation/1");
...
```javascript
const url = new URL("localhost/api/etablissement-prestation/1/edit");
...
```javascript
const url = new URL("localhost/api/prestation");
...
```javascript
const url = new URL("localhost/api/prestation/create");
...
```javascript
const url = new URL("localhost/api/prestation/1");
...
```javascript
const url = new URL("localhost/api/prestation/1/edit");
...
```javascript
const url = new URL("localhost/api/facture");
...
```javascript
const url = new URL("localhost/api/facture/create");
...
```javascript
const url = new URL("localhost/api/facture/1/edit");
...
```javascript
const url = new URL("localhost/api/facture-recouvrement/1");
...
```javascript
const url = new URL("localhost/api/facture-rappel/1");
...
```javascript
const url = new URL("localhost/api/facture-prestation");
...
```javascript
const url = new URL("localhost/api/facture-prestation/create");
...
```javascript
const url = new URL("localhost/api/facture-prestation/1");
...
```javascript
const url = new URL("localhost/api/facture-prestation/1/edit");
...
```javascript
const url = new URL("localhost/api/valider-prestation/1");
...
```javascript
const url = new URL("localhost/api/rejeter-prestation/1");
...
```javascript
const url = new URL("localhost/api/comptable");
...
```javascript
const url = new URL("localhost/api/comptable/create");
...
```javascript
const url = new URL("localhost/api/comptable/1");
...
```javascript
const url = new URL("localhost/api/comptable/1/edit");
...
```javascript
const url = new URL("localhost/api/assistante");
...
```javascript
const url = new URL("localhost/api/assistante/create");
...
```javascript
const url = new URL("localhost/api/assistante/1");
...
```javascript
const url = new URL("localhost/api/assistante/1/edit");
...
```javascript
const url = new URL("localhost/api/patient-decede/1");
...
```javascript
const url = new URL("localhost/api/patient-with-medecin-control");
...
```javascript
const url = new URL("localhost/api/first_patient-with-medecin-control/1");
...
```javascript
const url = new URL("localhost/api/next_patient-with-medecin-control/1/1");
...
```javascript
const url = new URL("localhost/api/number_patient-with-medecin-control");
...
```javascript
const url = new URL("localhost/api/specialite");
...
```javascript
const url = new URL("localhost/api/specialite/1");
...
```javascript
const url = new URL("localhost/api/consultation-type");
...
```javascript
const url = new URL("localhost/api/consultation-type/1");
...
```javascript
const url = new URL("localhost/api/souscripteur");
...
```javascript
const url = new URL("localhost/api/souscripteur/create");
...
```javascript
const url = new URL("localhost/api/souscripteur/1/edit");
...
## api/BabanaExpress-contrat

> Example request:

```bash
curl -X POST \
    "localhost/api/BabanaExpress-contrat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```

```javascript
const url = new URL("localhost/api/BabanaExpress-contrat");
...
`POST api/BabanaExpress-contrat`
...
```javascript
const url = new URL("localhost/api/patient/add-etablissement");
...
```javascript
const url = new URL("localhost/api/association");
...
```javascript
const url = new URL("localhost/api/association/1");
...
```javascript
const url = new URL("localhost/api/facture-avis");
...
```javascript
const url = new URL("localhost/api/facture-avis/create");
...
```javascript
const url = new URL("localhost/api/facture-avis/1");
...
```javascript
const url = new URL("localhost/api/facture-avis/1/edit");
...
```javascript
const url = new URL("localhost/api/medicament");
...
```javascript
const url = new URL("localhost/api/medicament/1");
...
```javascript
const url = new URL("localhost/api/medicament/search/1");
...
```javascript
const url = new URL("localhost/api/ordonance");
...
```javascript
const url = new URL("localhost/api/ordonance/1");
...
```javascript
const url = new URL("localhost/api/ordonance/1/transmettre");
...
```javascript
const url = new URL("localhost/api/file/1");
...
```javascript
const url = new URL("localhost/api/financeur");
...
```javascript
const url = new URL("localhost/api/financeur/create");
...
```javascript
const url = new URL("localhost/api/financeur/1");
...
```javascript
const url = new URL("localhost/api/financeur/1/edit");
...
```javascript
const url = new URL("localhost/api/financeur/retirer");
...
```javascript
const url = new URL("localhost/api/ligne-temps");
...
```javascript
const url = new URL("localhost/api/ligne-temps/create");
...
```javascript
const url = new URL("localhost/api/ligne-temps/1");
...
```javascript
const url = new URL("localhost/api/ligne-temps/1/edit");
...
```javascript
const url = new URL("localhost/api/ligne-temps/dossier/1");
...
```javascript
const url = new URL("localhost/api/examen-prix");
...
```javascript
const url = new URL("localhost/api/examen-prix/create");
...
```javascript
const url = new URL("localhost/api/examen-prix/1");
...
```javascript
const url = new URL("localhost/api/examen-prix/1/edit");
...
```javascript
const url = new URL("localhost/api/examen-prix/etablissement/save");
...
```javascript
const url = new URL("localhost/api/patient/1/contrat-medicasure");
...
```javascript
const url = new URL("localhost/api/trajet-patient/dossier/1");
...
```javascript
const url = new URL("localhost/api/examen-complementaire/etablissement/1");
...
```javascript
const url = new URL("localhost/api/medicasure/souscripteur");
...
```javascript
const url = new URL("localhost/api/medicasure/souscripteur/1");
...
```javascript
const url = new URL("localhost/api/payment-prestation");
...
```javascript
const url = new URL("localhost/api/payment-prestation/1");
...
```javascript
const url = new URL("localhost/api/payment-statut/1");
...
```javascript
const url = new URL("localhost/api/payment");
...
```javascript
const url = new URL("localhost/api/payment/create");
...
```javascript
const url = new URL("localhost/api/payment/1");
...
```javascript
const url = new URL("localhost/api/payment/1/edit");
...
```javascript
const url = new URL("localhost/api/snomed-icd/map/1");
...
```javascript
const url = new URL("localhost/api/anamnese");
...
```javascript
const url = new URL("localhost/api/examen-clinic");
...
```javascript
const url = new URL("localhost/api/examen-complementaire");
...
```javascript
const url = new URL("localhost/api/other-complementaire");
...
```javascript
const url = new URL("localhost/api/offres");
...
```javascript
const url = new URL("localhost/api/offres/create");
...
```javascript
const url = new URL("localhost/api/offres/1");
...
```javascript
const url = new URL("localhost/api/offres/1/edit");
...
```javascript
const url = new URL("localhost/api/paiement/momo/paid");
...
```javascript
const url = new URL("localhost/api/paiement/momo/paymentStatus");
...
```javascript
const url = new URL("localhost/api/paiement/om/paid");
...
```javascript
const url = new URL("localhost/api/paiement/om/paymentStatus");
...
```javascript
const url = new URL("localhost/api/paiement/stripe-paiement");
...
```javascript
const url = new URL("localhost/api/paiement/stripe-paiement-medicasure");
...
```javascript
const url = new URL("localhost/api/paiement/stripe-paiement-success/1");
...
```javascript
const url = new URL("localhost/contrat-prepaye-store/1/redirect");
...
```javascript
const url = new URL("localhost/redirect-mesurlink/redirect/1");
...
```javascript
const url = new URL("localhost/medicasure/souscripteur");
...
```javascript
const url = new URL("localhost/medicasure/souscripteur/1");
